...
if (isRStudio) {
  rm(list = ls())
  setwd(
    "/mnt/DDrive/Github/Bio/Projects/covid-19/covid19modeling/cpp-v4-6e-severe-classes"
  )
} else {
  png("basic_traj.png")
}
...
library(curl)
curl_download("http://covidtracking.com/api/states/daily.csv",
              "daily.csv")
